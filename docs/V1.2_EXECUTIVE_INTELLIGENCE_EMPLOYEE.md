# v1.2 – Executive Intelligence Layer (Employee Revenue Mode)
...
### Sales data (for revenue aggregation)

| Item | Value |
|------|--------|
| **Model** | `SalesEntry` |
| **Key fields** | `date`, `month` (YYYY-MM), `userId`, `amount` (Int, SAR) |
...
- **Section:** “Employee Intelligence”
  - Table: Name, Revenue MTD, Target, Ach%, Trend, Consistency, ERS, Label
